\section{The isobar decomposition}
    ...
    In quantum mechanics, the quantity that describes the distribution of some observed events is the event intensity\index{intensity}, $\Intensity(\tau)$, being $\tau$ the coordinate of the event in its phase space.
