\subsection{Single-resonance Dalitz plots}
    ...
    \begin{figure}
        ...
        \subfloat[][\label{fig:f0_only_magnitude}]{\input{fig/f0/decay_amplitude.pgf}}
    ...
    \begin{figure}
        ...
        \subfloat[][Result of the model-independent fit to the plot shown above.\label{fig:dalitz_f0_980_only_result}]{\input{fig/f0/dalitz_fit.pgf}}
    ...
    \begin{figure}
        ...
        \subfloat[][\label{fig:f2_only_phase_fit}]{\input{fig/f2/phase.pgf}}

        \subfloat[][\label{fig:f2_only_amplitude}]{\input{fig/f2/decay_amplitude.pgf}}
