\section{Dalitz-plot analysis}
   ...
   There are several possible choices for the observable pair to parametrize $\tau$.
    ...
    \begin{figure}
        ...
        \subfloat[]%
                 [P wave.]%
                 {\input{fig/angular_part/p_wave_angular_dalitz.pgf}}

        \subfloat[]%
                 [D wave.]%
                 {\input{fig/angular_part/d_wave_angular_dalitz.pgf}}
