\section{Isobar decomposition}
    ...
    These functions depend on a parameter, $R$---the resonance \emph{radial size}\index{radial size}---and on $q$, the break-up momentum\index{break-up momentum} of the daughter particles of the sub-decay they refer to.
    \begin{figure}
        \centering
