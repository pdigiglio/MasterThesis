...
\label{chap:yap}
    ...
    To speed up the amplitude calculation, in the future \pac{yap} may make use of \acsp{gpu} as co-processors by means of the \package{OpenCL} or the Nvidia's \pacs{cuda} frameworks.
